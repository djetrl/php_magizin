...
$id_user = $stmt['ID'];
$result = '{"pokupki":[';
$sql = sprintf ('SELECT t.ID,t.TITLE,t.DESCRIPTION,t.PRICE, c.COUNT,cat.NAME FROM `korzina` AS k
JOIN `tovar` AS t ON c.ID_TOVAR = t.ID
JOIN `category` AS cat ON t.ID_CAT = cat.ID
